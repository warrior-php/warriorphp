!(function (a) {
    a(["jquery"], function (a) {
        return (function () {
            function h(a, b, c) {
                return u({
                    type: e.error, iconClass: v().iconClasses.error, message: a, optionsOverride: c, title: b,
                });
            }
            ...
            function j(a, b, c) {
                return u({
                    type: e.info, iconClass: v().iconClasses.info, message: a, optionsOverride: c, title: b,
                });
            }
            ...
            function l(a, b, c) {
                return u({
                    type: e.success, iconClass: v().iconClasses.success, message: a, optionsOverride: c, title: b,
                });
            }

            function m(a, b, c) {
                return u({
                    type: e.warning, iconClass: v().iconClasses.warning, message: a, optionsOverride: c, title: b,
                });
            }
            ...
            function u(c) {
                ...
                if (("undefined" != typeof c.optionsOverride && ((e = a.extend(e, c.optionsOverride)), (f = c.optionsOverride.iconClass || f)), !F(e, c))) {
                    d++, (b = i(e, !0));
                    var h = null, j = a("<div/>"), k = a("<div/>"), l = a("<div/>"), m = a("<div/>"), n = a(e.closeHtml), o = {intervalId: null, hideEta: null, maxHideTime: null}, p = {
                        toastId: d, state: "visible", startTime: new Date(), options: e, map: c,
                    };
    ...
    $("#pos-top-center").on("click", function () {
        toastr.info("I do not think that word means what you think it means.", "Top Center!", {
            positionClass: "toastr toast-top-center", containerId: "toast-top-center",
        });
    });
    ...
    $("#pos-top-right").on("click", function () {
        toastr.info("I do not think that word means what you think it means.", "Top Right!", {
            positionClass: "toastr toast-top-right", containerId: "toast-top-right",
        });
    });
    ...
    $("#pos-top-full").on("click", function () {
        toastr.info("I do not think that word means what you think it means.", "Top Full Width!", {
            positionClass: "toastr toast-top-full-width", containerId: "toast-top-full-width",
        });
    });
    ...
    $("#pos-bottom-left").on("click", function () {
        toastr.info("I do not think that word means what you think it means.", "Bottom Left!", {
            positionClass: "toastr toast-bottom-left", containerId: "toast-bottom-left",
        });
    });
    ...
    $("#pos-bottom-center").on("click", function () {
        toastr.info("I do not think that word means what you think it means.", "Bottom Center!", {
            positionClass: "toastr toast-bottom-center", containerId: "toast-bottom-center",
        });
    });
    ...
    $("#pos-bottom-right").on("click", function () {
        toastr.info("I do not think that word means what you think it means.", "Bottom Right!", {
            positionClass: "toastr toast-bottom-right", containerId: "toast-bottom-right",
        });
    });
    ...
    $("#pos-bottom-full").on("click", function () {
        toastr.info("I do not think that word means what you think it means.", "Bottom Full Width!", {
            positionClass: "toastr toast-bottom-full-width", containerId: "toast-bottom-full-width",
        });
    });
    ...
    $("#slide-toast").on("click", function () {
        toastr.success("I do not think that word means what you think it means.", "Slide Down / Slide Up!", {showMethod: "slideDown", hideMethod: "slideUp", timeOut: 1000});
    });
